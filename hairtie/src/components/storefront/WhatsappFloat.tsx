...
export function WhatsappFloat({ number, storeName }: { number: string; storeName: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-40 grid h-12 w-12 place-items-center rounded-full shadow-lg transition hover:scale-105 md:bottom-6 md:right-6 md:h-13 md:w-13"
